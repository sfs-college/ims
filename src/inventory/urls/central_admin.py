...
urlpatterns = [
    ...
    path('purchases/<slug:purchase_slug>/upload-invoice/', central_admin.PurchaseUploadInvoiceView.as_view(), name='purchase_upload_invoice'),
    path('purchases/<slug:purchase_slug>/invoice/', central_admin.PurchaseInvoiceViewView.as_view(), name='purchase_view_invoice'),
    ...
    path('api/toggle-item-condition/', aura.toggle_item_condition, name='toggle_item_condition'),
